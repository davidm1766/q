...
[assembly: ExportRenderer(typeof(AdBanner), typeof(AdRewardedView_Droid))]
namespace Ads.Droid
{
    public class AdRewardedView_Droid : ViewRenderer, IRewardedVideoAdListener
    {
        private IAdsNotifty _iadinter;
        public AdRewardedView_Droid() : base(Android.App.Application.Context)
        {
        }

        public AdRewardedView_Droid(IAdsNotifty inter) : base(Android.App.Application.Context) {
            _iadinter = inter;
        }
